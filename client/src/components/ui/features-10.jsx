                    ...
                    <FeatureCard>
                        ...
                        <div className="relative mb-6 border-t border-dashed sm:mb-0">
                            ...
                            <div className="aspect-[76/59] p-1 px-6">
                                <DualModeImage
                                    darkSrc="https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&q=80"
                                    lightSrc="https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&q=80"
                    ...
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                ...
                                description="Scheduling system, instantly plan pentests."
                            />
                        </CardHeader>
                        ...
                        <CardContent>
                            <div className="relative mb-6 sm:mb-0">
                                ...
                                <div className="aspect-[76/59] border">
                                    <DualModeImage
                                        darkSrc="https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fit=crop&q=80"
                                        lightSrc="https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fit=crop&q=80"
...
const DualModeImage = ({ darkSrc, lightSrc, alt, width, height, className }) => (
    <>
        <img
            src={darkSrc}
...
const CircularUI = ({ label, circles, className }) => (

  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Start securing your applications today</p>

        <form style={styles.form} onSubmit={handleSubmit}>
          <div>
            <label style={styles.label}>Your name</label>
            <input {...inputProps('name', 'text', 'John Doe')} />
          </div>
          <div>
            <label style={styles.label}>Organization name</label>
            <input {...inputProps('org_name', 'text', 'Acme Corp')} />
          </div>
          <div>
            <label style={styles.label}>Email</label>
            <input {...inputProps('email', 'email', 'you@company.com')} />
          </div>
          <div>
            <label style={styles.label}>Password</label>
            <input {...inputProps('password', 'password', '••••••••')} minLength={8} />
          </div>
